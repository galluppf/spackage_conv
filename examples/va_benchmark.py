...
if simulator_name == 'spiNNaker':   
    get_db().set_number_of_neurons_per_core('IF_curr_exp', 100)      # this will set 100 neurons per core
    get_db().set_number_of_neurons_per_core('IF_cond_exp', 50)      # this will set 50 neurons per core
...
ax.scatter(exc_spikes[:,1], exc_spikes[:,0], linewidths=(0,), s=5, c='b')
ax.scatter(inh_spikes[:,1], inh_spikes[:,0] + n_exc, linewidths=(0,), s=5, c='r')
pylab.show()
