...
INSERT INTO "connector_types" VALUES(5,'ConvolutionConnector');
...
CREATE TABLE cell_types (
    ...
    "name" TEXT, 
    "image_name" TEXT,
    "generate_sdram_connectivity" INTEGER
);
INSERT INTO "cell_types" VALUES(1,100,'IF_curr_exp','app_frame_lif.aplx',1);
INSERT INTO "cell_types" VALUES(2,10,'IZK_curr_exp','app_frame_izhikevich.aplx',1);
INSERT INTO "cell_types" VALUES(3,300,'NEF_OUT_1D','app_frame_nef_out_1d.aplx',1);
INSERT INTO "cell_types" VALUES(4,50,'IF_cond_exp','app_frame_lif_cond.aplx',1);
INSERT INTO "cell_types" VALUES(5,50,'IF_curr_exp_32','app_frame_lif_32.aplx',1);
INSERT INTO "cell_types" VALUES(6,1000,'Dummy','app_frame_dummy.aplx',1);
INSERT INTO "cell_types" VALUES(7,200,'IF_NEF_2D','app_frame_lif_nef_2d.aplx',1);
INSERT INTO "cell_types" VALUES(8,200,'NEF_OUT_2D','app_frame_nef_out_2d.aplx',1);
INSERT INTO "cell_types" VALUES(9,2048,'ProxyNeuron','app_proxy.aplx',1);
INSERT INTO "cell_types" VALUES(97,300,'IF_NEF_1D','app_frame_lif_nef_1d.aplx',1);
INSERT INTO "cell_types" VALUES(99,2048,'SpikeSourceArray','app_frame_spike_source_array.aplx',1);
INSERT INTO "cell_types" VALUES(100,2048,'SpikeSourcePoisson','app_frame_spike_source_poisson.aplx',1);
INSERT INTO "cell_types" VALUES(101,1,'SpikeSink','app_frame_spike_sink.aplx',1);
INSERT INTO "cell_types" VALUES(102,1,'Recorder','app_monitoring.aplx',0);
INSERT INTO "cell_types" VALUES(103,2048,'SpikeSource','app_frame_spike_source.aplx',1);
INSERT INTO "cell_types" VALUES(104,2048,'convolution','app_convolution.aplx',0);
...
INSERT INTO "synapse_types" VALUES(26,'excitatory',0,104,'[[0, 1, 15, 0], [0, 1, 2047, 4], [0, 256, 65535, 15], [0, 1, 0, 31], [0, 1, 1, 31]]');
INSERT INTO "synapse_types" VALUES(27,'inhibitory',1,104,'[[0, 1, 15, 0], [0, 1, 2047, 4], [0, 256, 65535, 15], [0, 1, 0, 31], [0, 1, 1, 31]]');
...
INSERT INTO "cell_parameters" VALUES(1,121,104,'v','i','int(value)*65536',1);
INSERT INTO "cell_parameters" VALUES(2,122,104,'time_last_input_spike','I','0',1);
INSERT INTO "cell_parameters" VALUES(3,123,104,'time_last_output_spike','I','0',1);
INSERT INTO "cell_parameters" VALUES(1,124,104,'tau_m','I','int(65536/value)',2);
INSERT INTO "cell_parameters" VALUES(2,125,104,'v_thresh','i','int(value)*65536',2);
INSERT INTO "cell_parameters" VALUES(3,126,104,'v_reset','i','int(value)*65536',2);
INSERT INTO "cell_parameters" VALUES(4,127,104,'v_rest','i','int(value)*65536',2);
INSERT INTO "cell_parameters" VALUES(5,128,104,'tau_refrac','I','int(value)',2);
INSERT INTO "cell_parameters" VALUES(6,129,104,'size_map_x','H','int(value)',2);
INSERT INTO "cell_parameters" VALUES(7,130,104,'size_map_y','H','int(value)',2);
DELETE FROM sqlite_sequence;
INSERT INTO "sqlite_sequence" VALUES('flags',7);
INSERT INTO "sqlite_sequence" VALUES('cell_parameters',130);
